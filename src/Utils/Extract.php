...
class Extract
{
    ...
    public static function unique_object_keys()
    {
        return array_unique(self::show_keys(json_decode($json, true)), SORT_REGULAR);
    }

    public static function show_keys($ar)
    {
        ...
        foreach ($ar as $k => $v) {
            ...
            if (is_array($v)) {
                ...
                $temp = array_merge($temp, self::show_keys($v));
            }
        }
